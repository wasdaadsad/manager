...
<html lang="en">
	<head>
		<title>${thissystem.systemName}</title>
		...
		<!--[if !IE]> -->
		<script src="${contextPath}/aceadmin/assets/js/jquery.js"></script>
		<!-- <![endif]-->
		...
		<!--[if lte IE 8]>
		  <script src="${contextPath}/aceadmin/assets/js/excanvas.js"></script>
		<![endif]-->
		
		<script src="${contextPath}/aceadmin/assets/js/jquery-ui.custom.js"></script>
		<script src="${contextPath}/aceadmin/assets/js/jquery.ui.touch-punch.js"></script>
		<!-- ace scripts -->
		<script src="${contextPath}/aceadmin/assets/js/ace/elements.scroller.js"></script>
		<script src="${contextPath}/aceadmin/assets/js/ace/ace.js"></script>
		<script src="${contextPath}/aceadmin/assets/js/ace/ace.sidebar.js"></script>
		<script src="${contextPath}/aceadmin/assets/js/ace/ace.sidebar-scroll-1.js"></script>
		<script src="${contextPath}/aceadmin/assets/js/ace/ace.submenu-hover.js"></script>
			...
			<div class="navbar-container" id="navbar-container">
				...
				<div class="navbar-header pull-left">
					...
					<a href="#" class="navbar-brand">
						<small>${thissystem.systemName}</small>
					</a>
					...
					<ul class="nav ace-nav">
						...
						<li class="light-blue">
							<a data-toggle="dropdown" href="#" class="dropdown-toggle">
								<img class="nav-user-photo" src="${contextPath}/aceadmin/assets/avatars/avatar5.png"  />
