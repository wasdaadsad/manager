                ...
                <div class="widget-box">
                    <div class="widget-header widget-header-flat widget-header-small">
                        <h5 class="widget-title" id="title">
                            <i class="ace-icon fa fa-signal"></i> 诊断网点统计
                        </h5>
                        ...
                        <div class="toolbar" id="toolbar">
                            <div class="clearfix">
                                <div class="row">
                                    <div class="col-xs-1 ">
                                        <label>周期：</label>
                                        <select name="rangeType" id="rangeType" style="width: 60px" onchange="changeDatePicker()">
...
<script type="text/javascript">
    ...
    function loadCompareData() {
        ...
        $.post('${contextPath}/analysis/checkData/checkedCssPoint.json', formData, function (data) {
            if (data.stat == 200) {
                Highcharts.chart('container', {
                    chart: {
                        type: 'line'
        ...
        $.post('${contextPath}/analysis/checkData/checkedSiteDistributed.json', formData, function (data) {
            if (data.stat == 200) {
                Highcharts.chart('container2', {
                    chart: {
                        type: 'column'
        ...
        $.post('${contextPath}/analysis/checkData/checkedSitePercent.json', formData, function (data) {
            if (data.stat == 200) {
                Highcharts.chart('container3', {
                    chart: {
                        type: 'spline'
        ...
        $.post('${contextPath}/analysis/checkData/averageCheckedCount.json', formData, function (data) {
            if (data.stat == 200) {
                Highcharts.chart('container4', {
                    chart: {
                        type: 'spline'
