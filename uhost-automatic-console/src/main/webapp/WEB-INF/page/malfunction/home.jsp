                            ...
                            <div class="clearfix">
                                <div class="row">
                                    <div class="col-xs-2 nopadding-right">
                                        <label for="ccIdselect">代理代码：</label>
                                    ...
                                    <div class="col-xs-2 nopadding-right">
                                        <label for="netpotSelect">网点代码：</label>
                                        <select name="cssCode" id="netpotSelect">
                                ...
                                <div class="row">
                                    <div class="col-xs-2">
                                        <input type="text" name="cwoBarcode"
    ...
    function ccidChanged() {
        ...
        $.post('${contextPath}/admin/netport/ccidChanged.json', {'ccId': ccId}, function (data) {
            if (data.stat == 200) {
                ...
                $("select[name='cssCode']").html(str);
                $("select[name='cssCode']").comboSelect();
            }
        });
    }
