                ...
                <div class="widget-box">
                    <div class="widget-header widget-header-flat widget-header-small">
                        <h5 class="widget-title" id="title">
                            <i class="ace-icon fa fa-signal"></i> server列表
                        </h5>
    ...
    jQuery(function ($) {
        ...
        $(grid_selector).jqGrid({
            ...
            colModel: [
                ...
                {name: 'serverAddress', index: 'server_address', align: "center", sortable: false, width: 55},
                ...
                {name: 'state', index: 'state', align: "center", sortable: false, width: 45, stype: "select"},
                {
                    name: 'urlPath',
                    index: 'urlPath',
                    align: "center",
