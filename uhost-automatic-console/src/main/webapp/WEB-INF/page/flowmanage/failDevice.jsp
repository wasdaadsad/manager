...
<script type="text/javascript">
    ...
    jQuery(function ($) {
        ...
        $(grid_selector).jqGrid({
            url: "${contextPath}/admin/device/faillist",
            datatype: "json",
            mtype: "post",
            postData: formData,
            ...
            colModel: [
                ...
                {name: 'detailId', index: 'detailId', align: "center", sortable: false, width: 60},
                {name: 'status', index: 'status', align: "center", sortable: false, width: 50},
