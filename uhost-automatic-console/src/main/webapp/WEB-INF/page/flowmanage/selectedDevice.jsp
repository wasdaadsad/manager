                        ...
                        <div class="toolbar" id="toolbar">
                            <div class="clearfix">
                                <div class="row">
                                    ...
                                    <div class="col-xs-2 nopadding-right">
                                        <input name="taskId" id="taskId" type="text" readonly="readonly"  style="display: none"
                                               class="input-sm col-xs-12" value="${taskId}">
                                    </div>
                                </div>
                                <div class="row" style="margin-top: 10px">
                                    <div class="col-xs-5 nopadding-right">
                                        <label for="uhost">任务状态：</label>
                                        <select name="uhost" id="uhost" placeholder="输入网点编码">
                                    ...
                                    <%--</div>
                                    <div class="col-xs-2 nopadding-right">--%>
                                        <label for="state">流程状态：</label>
                                        <select name="state" id="state" placeholder="输入网点编码">
...
<script type="text/javascript">
    ...
    jQuery(function ($) {
        ...
        $(grid_selector).jqGrid({
            url: "${contextPath}/admin/device/selectlist",
            datatype: "json",
            mtype: "post",
            postData: formData,
            colNames: ['设备id', 'PCB_CODE', '当前任务', '任务状态', '开始时间', '最后更新时间','流程状态', '操作'],
            colModel: [
                {name: 'deviceId', index: 'deviceId', align: "center", sortable: false, width: 60},
                {name: 'pcb', index: 'pcb', align: "center", sortable: false, width: 60},
                {name: 'detailVP', index: 'detailVP', align: "center", sortable: false, width: 60},
                {name: 'statusVP', index: 'statusVP', align: "center", sortable: false, width: 50},
                {name: 'startTime', index: 'startTime', align: "center", sortable: false, width: 60},
                {name: 'endTimeVP', index: 'endTimeVP', align: "center", sortable: false, width: 60},
                {
                    name: 'processStateVP',
                    index: 'processStateVP',
                    align: "center",
                    sortable: false,
                    width: 40,
                }, {
