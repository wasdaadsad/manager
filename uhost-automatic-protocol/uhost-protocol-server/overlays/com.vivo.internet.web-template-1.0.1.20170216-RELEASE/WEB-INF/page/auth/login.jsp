...
<html lang="zh-cn">
	<head>
		...
		<meta charset="utf-8" />
		<title>vivo管理后台</title>

		<meta name="description" content="vivo 管理后台" />
		...
		<!--[if lte IE 9]>
			<link rel="stylesheet" href="${contextPath}/aceadmin/assets/css/ace-part2.css" />
		<![endif]-->
		<link rel="stylesheet" href="${contextPath}/aceadmin/assets/css/ace-rtl.css" />
	...
	<body class="login-layout light-login">
								...
								<div id="login-box" class="login-box visible widget-box no-border">
									<div class="widget-body">
										<div class="widget-main">
											<div class="center">
												<img src="${contextPath}/static/images/vivo-logo.png" width="130" height="80"/>
											</div>
		...
		<script type="text/javascript" src="${contextPath}/aceadmin/assets/js/jquery.validate.js"></script>
